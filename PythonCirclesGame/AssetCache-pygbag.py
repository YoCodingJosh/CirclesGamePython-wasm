...
def start_cache(resource_directory):
    global fpsFont, buttonFont, scoreFont, highPopSound, highPop2Sound, lowPopSound, badPopSound, jaguarSound, \
        handCursor, gameOverFont, titleFont, sirklesLogo, copyrightFont
    ...
    copyrightFont = pygame.font.Font(resource_directory + "freesansbold.ttf", 24)

    highPopSound = pygame.mixer.Sound(resource_directory + "highpop.ogg")
    highPop2Sound = pygame.mixer.Sound(resource_directory + "highpop2.ogg")
    lowPopSound = pygame.mixer.Sound(resource_directory + "lowpop.ogg")
    badPopSound = pygame.mixer.Sound(resource_directory + "badpop.ogg")
    jaguarSound = pygame.mixer.Sound(resource_directory + "jaguar.ogg")
